...
<div class="main-content">
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			...
			<li class="active">Управление продуктом</li>
		</ul>
		<!-- .breadcrumb -->
	</div>
	...
	<div class="page-content">
		<div class="row">
			<div class="col-xs-12">
				<h3 class="header smaller lighter blue">Продукт</h3>
					...
					<div id="sample-table-2_wrapper" class="dataTables_wrapper" role="grid">
						<?php $this->widget('GridView', array(
								...
								'columns'=>array(
									array(
										'name'=>'name_ua',
										'value'=>'CHtml::link("$data->name_ua-".$data->colors->number_color, "update/$data->id");',
										'type'=>'raw',
									),
									array(
										'name'=>'status',
